...
def make_dataset_ohaze(root: str, mode: str):
    # print(' in make_dataset_ohaze(root, mode)',root, mode)
    img_list = []
    # if mode == 'val':
    #     print('os.listdir(os.path.join(root, mode, hazy))',os.listdir(os.path.join(root, mode, 'hazy')))
...
class OHazeDataset(data.Dataset):
    def __init__(self, root, mode):
        self.root = root
        self.mode = mode
        # print('make_dataset_ohaze(root, mode)',root, mode)
